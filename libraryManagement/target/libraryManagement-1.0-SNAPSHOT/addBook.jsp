...
<div class="layui-container mc-ui-flex-center">
    <form action="${pageContext.request.contextPath}/book/addBook" class="layui-form layui-form-pane">
<!--        <div class="layui-form-item">-->
<!--            <label class="layui-form-label">实体图书ID</label>-->
...
<!--            </div>-->
<!--        </div>-->
        <input name="isbn" type="hidden" value="${param.isbn}">
        <div class="layui-form-item">
            <label class="layui-form-label">所在图书馆</label>
            <div class="layui-input-inline">
                <select name="lId">
                    <option value="1">陈延奎图书馆</option>
                    <option value="2">嘉庚图书馆</option>
                    <option value="3">诚毅图书馆</option>
                </select>
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input name="bPutTime" class="magicalcoder-laydate layui-input" type="text" autocomplete="off"
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                <a href="/libraryManagement/allBookInformation.jsp" class="layui-btn">返回</a>
            </div>
            <div class="layui-inline">

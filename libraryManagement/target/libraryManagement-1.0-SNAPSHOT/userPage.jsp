            ...
            var active = {
                detailAdd: function () {
                    ...
                    element.tabAdd('funcTab', {
                        title: '详情'
                        ,
                        content: '<iframe src="/libraryManagement/userDetail.jsp" width="1000px" height="700px" frameborder="0"></iframe>'
                ...
                allBookAdd: function () {
                    ...
                    element.tabAdd('funcTab', {
                        title: '所有图书信息'
                        ,
                        content: '<iframe src="/libraryManagement/allBookInformation.jsp" width="1000px" height="700px" frameborder="0"></iframe>'
                        ,
                        id: 'tab' + new Date().getTime() //实际使用一般是规定好的id，这里以时间戳模拟下
                    });
                ...
                allBorrowRecord: function () {
                    ...
                    element.tabAdd('funcTab', {
                        title: '借阅记录'
                        ,
                        content: '<iframe src="/libraryManagement/allBorrowRecord.jsp" width="1000px" height="700px" frameborder="0"></iframe>'
                        ,
                        id: 'tab' + new Date().getTime() //实际使用一般是规定好的id，这里以时间戳模拟下
                    });
                ...
                <div class="layui-col-md6 layui-col-lg2" style="height: 800px;">
                    <ul class="layui-nav layui-nav-tree" style="height: 800px;">
                        <li class="layui-nav-item">
                            <a id="detail" class="site-demo-active " data-type="detailAdd">学生详情</a>
                        </li>
                        <li class="layui-nav-item">
                            <a class="site-demo-active " data-type="allBookAdd">所有图书</a>

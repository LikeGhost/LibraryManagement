            ...
            $.ajax({
                ...
                success: function (resp) {
                    ...
                    $.each(resp, function (i, n) {
                        $("#clcContent").append("<option value=\""+n.clcId+"\">" + n.clcContent + "</option>");
...
<div class="layui-container mc-ui-flex-center">
    <form action="${pageContext.request.contextPath}/book/addBookInformation" class="layui-form layui-form-pane">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input name="isbn"class="layui-input" type="text" autocomplete="off"/>
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">中图编号</label>
            <div class="layui-input-inline">
                <select name="clcId"id="clcContent">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input name="biIntroduction"class="layui-input" type="text" autocomplete="off"/>
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">图书性质</label>
            <div class="layui-input-inline">
                <select name="btId"id="borrowType">
                    <option value="1">中文图书</option>
                    <option value="2">外文图书</option>
                </select>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input name="publishArea" class="layui-input" type="text" autocomplete="off"/>
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">出版社</label>
            <div class="layui-input-inline">
                <input name="publishHouse"class="layui-input" type="text" autocomplete="off"/>
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">出版时间</label>
            <div class="layui-input-inline">
                <input name="publishTime" class="magicalcoder-laydate layui-input" type="text" autocomplete="off"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input name="wordCount" class="layui-input" type="text" autocomplete="off"
                       lay-verify="magicalCoderVerify" mc-attr-bool-is-init-value="false" mc-attr-bool-show="false"
                       mc-attr-bool-show-bottom="false" mc-attr-str-type="date" mc-attr-str-trigger="click"/>
            </div>
        </div>

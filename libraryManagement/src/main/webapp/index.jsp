...
<body class="layui-form" style="" background="static/image/library.jpg">
<div id="magicalDragScene" class="mc-root mc-ui-absolute-pane " >
    <div class="layui-container mc-ui-flex-center"
         style="width: 100%; position: absolute; left: 0%; top: 15%; font-size: 100px;">
        <label class="layui-form-label mc-ui-flex-center" style="width: 25.4823%; font-size: 45px;color: #FFFFFF">图书管理系统</label>
    </div>
    <div class="layui-container mc-ui-flex-center" style="width: 100%; position: absolute; left: 0%; top: 35%;">
        <form action="${pageContext.request.contextPath}/login/canLogin" class="layui-form"
              style="width: 31.2504%; transform: rotate(0deg);" method="post">
            <div class="layui-form-item mc-ui-flex-center">
                <div class="layui-container" style="width: 100.556%;">
                    <label class="layui-form-label mc-ui-flex-center" style="color: #FFFFFF;">帐户</label>
                    <input name="uId" id="uIdInput" class="layui-input" style="width: 66.9781%;" type="text"
                           autocomplete="off"/>
                </div>
            </div>
            <div class="layui-form-item">
                <div class="layui-container" style="width: 100.556%;">
                    <label class="layui-form-label mc-ui-flex-center" style="color: #FFFFFF;">密码</label>
                    <input name="password" id="passwordInput" class="layui-input" style="width: 66.9781%;"
                           type="password"
                           autocomplete="off"/>
                </div>
            </div>
            <div class="layui-form-item">
                <div class="layui-container" style="width: 100.556%;">
                    <label class="layui-form-label mc-ui-flex-center" style="color: #FFFFFF;">选择图书馆</label>
                    <div class="layui-input-inline" style="width:66.9781%">
                        <select name="lName" >
                            <option>陈延奎图书馆</option>
                            <option>嘉庚图书馆</option>
                            <option>诚毅图书馆</option>
                        </select>
                    </div>
            ...
            <div class="layui-form-item mc-ui-flex-center">
                <input type="submit" id="loginButton" value="登录" class="layui-btn"/>
            </div>
        </form>
    </div>
</div>

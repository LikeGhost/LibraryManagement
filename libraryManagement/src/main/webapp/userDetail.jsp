...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            var rContent="${user.role.rContent}";
            if(rContent.indexOf("教师")!=-1){
                $("#name").text("教师姓名");

            }
            else if(rContent.indexOf("生")!=-1){
                $("#name").text("学生姓名");

            }
            else if(rContent.indexOf("管理员")!=-1){
                $("#name").text("管理员姓名");
            }
...
<div id="magicalDragScene" class="mc-root mc-ui-absolute-pane mc-ui-flex-center">
    <div class="layui-container mc-ui-flex-center" style="width: 100%; position: absolute; left: 0%; top: 0%;">
        <div class="layui-row layui-col-space20">
            <div class="layui-col-xs12 layui-col-lg12">
                <div class="layui-row">
                    <div class="layui-col-md6 layui-col-lg3 mc-ui-flex-center layui-bg-green" style="font-size: 25px;">
                        帐号
                    </div>
                    <div id="uId" class="layui-col-md6 layui-col-lg9 mc-ui-flex-center" style="font-size: 25px;">${user.uId}</div>
                </div>
            </div>
            <div class="layui-col-xs12 layui-col-lg12">
                <div class="layui-row">
                    <div id="name" class="layui-col-md6 layui-col-lg3 mc-ui-flex-center layui-bg-green" style="font-size: 25px;">
                        学生姓名
                    </div>
                    <div id="uName" class="layui-col-md6 layui-col-lg9 mc-ui-flex-center"
                         style="font-size: 25px;">${user.uName}</div>
                </div>
            </div>
            <div class="layui-col-xs12 layui-col-lg12">
                <div class="layui-row">
                    ...
                    <div id="sex" class="layui-col-md6 layui-col-lg9 mc-ui-flex-center" style="font-size: 25px;">
            ...
            <div class="layui-col-xs12 layui-col-lg12">
                <div class="layui-row">
                    <div id="kind" class="layui-col-md6 layui-col-lg3 mc-ui-flex-center layui-bg-green" style="font-size: 25px;">
                        身份
                    </div>
                    <div id="rContent" class="layui-col-md6 layui-col-lg9 mc-ui-flex-center"
                         style="font-size: 25px;">${user.role.rContent}</div>
                </div>
            </div>
            <div class="layui-col-xs12 layui-col-lg12">
                <div class="layui-row">
                    ...
                    <div id="mail" class="layui-col-md6 layui-col-lg9 mc-ui-flex-center" style="font-size: 25px;">${user.mail}</div>
                </div>
            </div>
        </div>
    </div>
